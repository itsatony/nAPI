...
ApiCore.prototype.run = function(resource, method, specifier, document, options, callback, user, debug) {
	...
	return this[resource][method][specifier](document, options, callback, user, debug);
};
